...
from pywidevine.cdm.widevine_key import WidevineKey
...
class Cdm:
    ...
    def close_session(self, session_id):
        ...
        if session_id in self.sessions:
            ...
            self.logger.debug("session {} not found".format(session_id))
            return 1
    ...
    def get_license_request(self, session_id):
        ...
        # if session.device_config.device_name == "chrome_cdm_1610":
        #     self.logger.debug("\nConnecting API for private key...")
        #     key = WidevineKey()
